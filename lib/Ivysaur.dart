...
class ivysaur extends StatefulWidget {


  @override
  _ivysaurState createState() => _ivysaurState();
}

class _ivysaurState extends State<ivysaur> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(appBar:AppBar(title: Text("Ivysaur",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),backgroundColor: Colors.cyan,),backgroundColor: Colors.cyan,body:
    Stack(
      children: <Widget>[
        Container(
        ...
        Center(
          ...
          Center(
            child: Column(
              children: <Widget>[
                SizedBox(height: 150,),
                Text("Height: 1.0 CM",style: TextStyle(color: Colors.black),),
                SizedBox(height: 25,),
                Text("Weight: 13 KG",style: TextStyle(color: Colors.black),),
                SizedBox(height: 40,),
                ...
                Container(
                    ...
                    child: Text(" Vensaur",style: TextStyle(color: Colors.black,fontSize: 15),)),SizedBox(width: 20,),
              ],),
          ),
            decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(10)),),
        ),
        Image(image: AssetImage('Assets/download.png'),height: 200,width: 400,),
